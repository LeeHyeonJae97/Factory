...
public class MoneySO : ScriptableObject
{
    ...
    public UnityAction<MoneySO> onValueChanged;

    public static void Load(EasyFileSave file)
    {
        if (_instances == null)
        {
            var tmp = Resources.LoadAll<MoneySO>("Money");
            _instances = new MoneySO[tmp.Length];
    ...
    public static MoneySO Get(int index)
    {
        return _instances[index];
    }

    public static MoneySO Get(MoneyType type)
    {
