...
namespace TigerForge
{
    ...
    public class EasyFileSave
    {
        ...
        protected EasyFileSaveExtension customs = new EasyFileSaveExtension();
            ...
            try
            {
                ...
                if (FileExists())
                {
                    ...
                    if (password == "")
                    {
                        ...
                        FileStream openFile = File.Open(filePath, FileMode.Open);
        ...
        public bool Load(string password = "")
        {
            ...
            if (!FileExists())
            {
                Error = "[Easy File Save] The file " + filePath + " doesn't exist.";
                return false;
            }
        ...
        public void Add(string key, object value, bool ignoreExistingKey = false)
        {
            ...
            //if(fileName.Equals("Farm"))
            //{
            //    Debug.Log(key);
            //    Debug.Log(storage.ContainsKey(key));
            //}
        }
